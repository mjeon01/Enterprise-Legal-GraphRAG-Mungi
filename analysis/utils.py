...
STOPWORDS = {
    ...
    "that", "it", "its", "he", "she", "they", "their", "what", "who",
    "which", "how", "when", "where", "why", "if", "as", "so", "no",
    "any", "all", "there", "been", "about", "into", "than", "then",
    "also", "such", "both", "each", "other",
}
...
def parse_id(passage_id: str) -> dict:
    ...
    if not m:
        return {"chapter": passage_id, "chapter_num": None, "section_num": None, "depth": 0}
